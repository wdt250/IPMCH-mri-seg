...
## DSAM
from ultralytics.nn.attention.DSAM import C2PSA_DSAM, DSAM, DSAMPlus
from ultralytics.utils.loss import v8SegmentationProtoLoss
...
class DeBiFormerProtoSegmentationModel(SegmentationModel):
    """
    只用于 DeBiFormerPlus + cross-plane prototype consistency。
    """

    def init_criterion(self):
        return v8SegmentationProtoLoss(
            self,
            feature_layer=10,   # 改成 DeBiFormerPlus 的实际层号
            lambda_proto=getattr(self, "lambda_proto", 0.02),
        )
